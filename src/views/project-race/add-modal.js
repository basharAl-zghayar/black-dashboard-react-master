...
const AddProjectRaceModal = ({ isVisible, setVisible, addProjectRace, formValues, updateProjectRace, isUpdate }) => {
    ...
    const onFinish = (values) => {
        ...
        if (isUpdate) {
            ...
            (async () => {
                await updateProjectRace(data);
                setLoading(false);
            })();
        } else {
            (async () => {
                await addProjectRace(data);
                setLoading(false);
            })();
        }
    };
...
export default AddProjectRaceModal;;